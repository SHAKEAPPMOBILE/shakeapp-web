    ...
    <div className="flex flex-col gap-[50px] items-center justify-center">
      ...
      <div className="flex flex-row gap-[25px] md:gap-[35px]">
        <a
          ...
          <button
            className="w-[130px] md:w-[180px] flex items-center justify-center gap-[7px] font-bold text-xl 
            cursor-pointer text-white bg-black rounded-lg py-[10px] md:py-[15px]">
            IOS
